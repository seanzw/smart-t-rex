...
(function () {
    ...
    Runner.prototype = {
        ...
        init: function () {
            ...
            // this.ql = new QLearner(QLearner.types.SingleObstacle);
        ...
        playIntro: function () {
            if (!this.activated && !this.crashed) {
                ...
                this.playing = true;
                this.activated = true;
                setTimeout(this.startGame.bind(this), 0);
        ...
        startGame: function () {
            ...
            // Do not pause the game for training.
        ...
        update: function () {
            ...
            if (this.playing) {
                ...
                var obstaclesJumpedOld = this.horizon.obstaclesJumped;
                ...
                var obstaclesJumpedDelta = this.horizon.obstaclesJumped - obstaclesJumpedOld;

                // Check for collisions.
                var collision = hasObstacles &&
                    checkForCollision(this.horizon.obstacles[0], this.tRex);
                // console.log(this.horizon.obstacles[0].xPos);
                ...
                if (true) {
                    ...
                    switch (result.action) {
                        case QLearner.actions.JUMP:
                            if (!this.tRex.jumping) {
                                this.tRex.startJump(this.currentSpeed);
                                //     setTimeout(this.tRex.startJump.bind(this.tRex), 0, this.currentSpeed);
                            }
                            break;
                        ...
                        //console.log("Nothing at %d", act_result.state);
                    }
                }
    ...
    function getTimeStamp(mode) {
        if (typeof getTimeStamp.time == 'undefined') {
            getTimeStamp.time = 0;
        }
        if (mode == 'reset') {
            getTimeStamp.time = 0;
        } else if (mode == 'update') {
            getTimeStamp.time += 1000 / 60;     // Fixed 60 FPS.
        }
    ...
    Horizon.prototype = {
        ...
        updateObstacles: function (deltaTime, currentSpeed) {
            // seanzw:
            // Here we make a shallow copy of the original array,
            // so that we can modify it while iterating through it.
